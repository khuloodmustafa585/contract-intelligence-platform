...
function quickAction(
  ...
  if (t === "expiring_soon")               return { label: "View Contract",    href: `/contracts/${contractId}`, icon: Timer         };
  if (t === "renewal_upcoming")            return { label: "View Contract",    href: `/contracts/${contractId}`, icon: Timer         };
  return null;
}
